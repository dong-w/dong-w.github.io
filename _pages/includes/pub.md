...
# 📝 Publications 
- ``ICSE'26`` **WiseUT: An Intelligent Framework for Unit Test Generation**. <br/>
...
- ``ICSE'25`` **Selecting Initial Seeds for Better JVM Fuzzing**.<br/>
...
- ``ASE'25`` **Clarifying Semantics of In-Context Examples for Unit Test Generation**.<br/>
...
- ``TOSEM'25`` **On the Evaluation of Large Language Models in Multilingual Vulnerability Repair**.<br/>
